@echo off
REM ============================================================
REM  AXIS-3 Robot Control - one-click builder for Windows
...
echo    - AXIS3-Robot-Control-Setup-1.0.0.exe        (installer)
echo    - AXIS3-Robot-Control-Portable-1.0.0.exe     (no install needed)
echo.
pause
exit /b 0
