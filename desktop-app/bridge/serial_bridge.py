...
"""AXIS-3 serial bridge: raw termios read/write over a tty, talking
...
# ("AXIS-3 Firmware v..." early, "System initialized." when setup is done).
# No new firmware protocol was invented — these lines already existed.
BANNER_MARKERS = (b"AXIS-3 Firmware", b"System initialized.")
