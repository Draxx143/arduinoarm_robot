...
// update() جلو می‌رود) و کتابخانه‌ی Servo آردوینو روی Mega از تایمر ۵
// استفاده می‌کند — با تایمر ۱ موتور حرکت (استپرها) تداخلی ندارد.
//
...
//     برد را ریست می‌کند.
//
// همه‌ی این عددها از همین‌جا قابل تنظیم‌اند و با
// tools/sync_gui_config.py به هر دو GUI هم منتقل می‌شوند:
//   • GRIP_MIN_DEG / GRIP_MAX_DEG ... کران بازه‌ی مجاز (درجه)
//   • GRIP_OPEN_DEG / GRIP_CLOSE_DEG ... زاویه‌ی «باز» و «بسته» (دستور open/close)
//   • GRIP_DEFAULT_DEG ............... زاویه‌ی شروع بعد از روشن شدن
//   • GRIP_SPEED_DEG_S ............... سرعت حرکت (درجه بر ثانیه)
//   • GRIP_MIN_US / GRIP_MAX_US ....... پالس حداقل/حداکثر سروو (کالیبراسیون)
#define GRIP_PIN             19     // پین سیگنال سروو (PWM؛ روی Mega آزاد است)
#define GRIP_MIN_DEG         0.0f   // بسته‌ترین حد مجاز
#define GRIP_MAX_DEG         180.0f // بازترین حد مجاز
#define GRIP_OPEN_DEG        20.0f  // «باز» — بسته به لینک پنجه تنظیمش کن
#define GRIP_CLOSE_DEG       160.0f // «بسته» — بسته به لینک پنجه تنظیمش کن
#define GRIP_DEFAULT_DEG     20.0f  // زاویه‌ی شروع (همان حالت باز)
#define GRIP_SPEED_DEG_S     120.0f // سرعت حرکت پنجه (درجه/ثانیه)
#define GRIP_MIN_US          500    // پالس ۰ درجه (µs) — کالیبره‌ی سروو
#define GRIP_MAX_US          2500   // پالس ۱۸۰ درجه (µs) — کالیبره‌ی سروو
