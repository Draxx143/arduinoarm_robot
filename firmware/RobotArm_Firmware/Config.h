...
// نسخه‌ی فریم‌ور. در بنرِ بوت («AXIS-3 Firmware v…») و در هر بلوکِ status
...
// ---- ترتیب اولویت هومینگ ----
// هومینگ کاملاً ترتیبی است: اول جوینت ۱، بعد جوینت ۲، بعد ۳ و ۴.
// هر جوینت باید جست‌وجو + بک‌آف را کامل تمام کند تا نوبت به بعدی برسد.
// (ایندکس‌ها صفر‌بنیان‌اند: 0=جوینت۱/X  1=جوینت۲/Y  2=جوینت۳/Z  3=گریپر/G)
// با دستور سریال «homeorder 1 2 3 4» در زمان اجرا هم قابل تغییر است.
#define HOMING_ORDER         {0, 1, 2, 3}
...
//
// گریپر (جوینت ۴، ایندکس ۳): ۹۰ درجه. یعنی بعد از هوم، ۹۰ درجه جلو
// می‌رود و آنجا صفر می‌شود؛ در نتیجه endstop دقیقاً در ۹۰- درجه قرار
// می‌گیرد و دامنه‌ی چرخش گریپر قرینه است (۹۰- تا ۹۰+).
// صفر = بدون آفست، همان نقطه‌ی endstop صفر می‌ماند.
#define HOMING_ZERO_OFFSET_DEG  {0.0f, 0.0f, 0.0f, 90.0f}
...
// ============================================
// AXIS Z (Joint 3) — دو موتوره؛ موتور دوم در بلوک AXIS Z2 پایین
// ============================================
...
// ============================================
// AXIS Z2 — موتور دوم جوینت ۳ (روبروی موتور اول)
// ============================================
// جوینت ۳ دو استپر روبروی هم دارد که دقیقاً یک پالس STEP می‌گیرند؛
// جهت موتور دوم همیشه آینه‌ی موتور اول است (AXIS_Z2_MIRROR_DIR).
// سرعت/شتاب/هوم/soft-limit از AXIS_Z می‌آید و اینجا فقط پین‌ها تعریف
// می‌شوند. انداستاپ مشترک است (پین ۱۸)؛ پین ۲ حالا آزاد است.
#define AXIS_Z2_STEP_PIN      26
#define AXIS_Z2_DIR_PIN       28
#define AXIS_Z2_ENABLE_PIN    24
#define AXIS_Z2_MIRROR_DIR  true   // موتور دوم روبروی موتور اول است

// ============================================
// AXIS G — گریپر (Joint 4)
// ============================================
#define AXIS_G_STEP_PIN     36
#define AXIS_G_DIR_PIN      34
#define AXIS_G_ENABLE_PIN   30
#define AXIS_G_ENDSTOP_PIN  15
// هر 2000 استپ = ۹۰ درجه  (200 * 16 * 2.5 / 360 = 22.22 استپ بر درجه)
#define AXIS_G_STEPS_PER_REV  200
#define AXIS_G_MICROSTEP      16
#define AXIS_G_GEAR_RATIO     2.5
#define AXIS_G_INVERT_DIR     true
#define AXIS_G_MAX_SPEED      1000   // steps/second  (= 45°/s)
#define AXIS_G_ACCELERATION   4000   // steps/s²  (رمپ ~۰.۱۶ ثانیه)
#define AXIS_G_HOMING_SPEED   700    // steps/s
#define AXIS_G_BACKOFF        200
...
#define AXIS_G_SOFT_MIN      -2000   // -90° × 22.22 (گریپر، جوینت ۴: قرینه)
#define AXIS_G_SOFT_MAX       2000   // +90° × 22.22
