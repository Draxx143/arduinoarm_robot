...
# -*- coding: utf-8 -*-
"""
مقایسه‌ی «کد قبل از اصلاح» با «کد بعد از اصلاح» برای موتور حرکت بازوی ۴ محوره.
...
AXES = {
    ...
    # (موتور دوم جوینت ۳ دقیقاً هم‌زمان با موتور اول حرکت می‌کند — زمان جدا ندارد)
    "G": dict(ms=1000, ac=500,  acn=4000, hs=700, bo=200,  spd=200*16*2.5/360.0, lo=-2000, hi=2000),
}
